...
function setTintColor() {
  var colors = [0x121215, 0x18181b, 0x27272a, 0x1f1f23];
...
function init() {
  ...
  var gmaterial = new THREE.MeshBasicMaterial({ color: currentThemeColor, side: THREE.DoubleSide, transparent: true, opacity: 0.8 });
  var gparticular = new THREE.CircleGeometry(0.02, 4);
  var aparticular = 6;
...
var lightBack = new THREE.PointLight(0xFFFFFF, 1.5);
...
var gridHelper = new THREE.GridHelper(60, 120, currentThemeColor, 0x27272a);
city.add(gridHelper);
